...
export default function StatsPage() {
  ...
  const [ignoredFiles, setIgnoredFiles] = useState<IgnoredFilesStats | null>(
    null,
  );
  const [ignoredFilesLoading, setIgnoredFilesLoading] = useState(false);
  const [duplicateFolders, setDuplicateFolders] =
    useState<DuplicateFoldersStats | null>(null);
      ...
      <ProtectedRoute>
        ...
        <div className="space-y-8">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            {folder.last_visited
                              ? typeof folder.days_since_visited === "number"
                                ? folder.days_since_visited < 1
                                  ? "Today"
                                  : folder.days_since_visited < 2
                                    ? "Yesterday"
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-lg shadow">
                <div className="px-6 py-4 border-b border-gray-200">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Visual overview of which folders use the most space - darker
                    colors indicate larger folders
                  </p>
                </div>
                <div className="p-6">
                  <FolderHeatmap
                    folders={stats.largest_folders_by_size}
                    type="size"
                    maxItems={20}
                  />
                </div>
              ...
              <div className="bg-white rounded-lg shadow">
                <div className="px-6 py-4 border-b border-gray-200">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Visual overview of which folders contain the most photos -
                    darker colors indicate more photos
                  </p>
                </div>
                <div className="p-6">
                  <FolderHeatmap
                    folders={stats.largest_folders_by_count}
                    type="count"
                    maxItems={20}
                  />
                </div>
                ...
                <div className="p-6">
                  <div className="space-y-3">
                    {stats.file_types.slice(0, 8).map((type, index) => {
                      const percentage =
                        (type.count / stats.basic.total_photos) * 100;
                      return (
                        <div
                          key={index}
                ...
                <div className="p-6">
                  <div className="space-y-3">
                    {stats.top_cameras.slice(0, 8).map((camera, index) => {
                      const percentage =
                        stats.metadata.photos_with_camera_info > 0
                          ? (camera.photo_count /
                              stats.metadata.photos_with_camera_info) *
                            100
                          : 0;
                      return (
                        <div
            ...
            <section id="videos" className="space-y-6 scroll-mt-24">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-2xl font-bold text-gray-900">
                        {Number(
                          stats.videos.stats.total_videos,
                        ).toLocaleString()}
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-2xl font-bold text-gray-900">
                        {formatBytes(
                          Number(stats.videos.stats.total_size_bytes),
                        )}
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-2xl font-bold text-gray-900">
                        {formatBytes(Number(stats.videos.stats.avg_size_bytes))}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-2xl font-bold text-gray-900">
                        {formatBytes(Number(stats.videos.stats.max_size_bytes))}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="p-6">
                    <div className="space-y-3">
                      {stats.videos.formats.slice(0, 8).map((format, index) => {
                        const percentage =
                          (Number(format.count) /
                            Number(stats.videos!.stats.total_videos)) *
                          100;
                        return (
                          <div
                            key={index}
                          ...
                          >
                            ...
                            <div className="ml-4 text-sm text-gray-500 min-w-0 text-right">
                              ...
                              <div className="text-xs">
                                {formatBytes(Number(format.total_size_bytes))}
                              </div>
                            </div>
                          </div>
                        );
                ...
                <div className="bg-white rounded-lg shadow">
                  ...
                  <div className="p-6">
                    <div className="space-y-3">
                      {stats.videos.folders_with_most
                        .slice(0, 8)
                        .map((folder, index) => (
                          <div
                            key={index}
                          ...
                          >
                            ...
                            <div className="ml-4 text-sm text-gray-500 text-right">
                              <div>
                                {Number(folder.video_count).toLocaleString()}{" "}
                                videos
                              </div>
                              <div className="text-xs">
                                {formatBytes(Number(folder.total_size_bytes))}
                              </div>
                            </div>
                          </div>
                        ))}
          ...
          <section id="duplicates" className="space-y-6 scroll-mt-24">
            ...
            {/* Duplicate KPIs Grouped */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* File Duplicates Group */}
              {duplicates && (
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-4 bg-yellow-50 rounded-lg">
                      ...
                      <p className="text-2xl font-bold text-gray-900">
                        {duplicates.summary.total_duplicate_filenames}
                      </p>
                    </div>
                    <div className="text-center p-4 bg-green-50 rounded-lg">
                      ...
                      <p className="text-2xl font-bold text-gray-900">
                        {formatBytes(
                          duplicates.summary.potential_space_saved_bytes || 0,
                        )}
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-4 bg-purple-50 rounded-lg">
                      ...
                      <p className="text-2xl font-bold text-gray-900">
                        {duplicateFolders.summary.total_duplicate_folder_groups}
                      </p>
                    </div>
                      ...
                      <div className="space-y-6">
                              ...
                              <div className="flex justify-between items-start mb-3">
                                <h4 className="font-medium text-gray-900">
                                  ...
                                  <span className="text-gray-500">
                                    ({formatBytes(group.photos[0].size)})
                                  </span>
                                </h4>
                        ...
                        {duplicates.duplicates.length > 10 && (
                          <div className="text-center py-4 text-gray-500">
                            ... and {duplicates.duplicates.length - 10} more
                    ...
                    <div className="p-6">
                      <div className="space-y-6">
                        ...
                        {duplicateFolders.duplicates.length > 10 && (
                          <div className="text-center py-4 text-gray-500">
                            ... and {duplicateFolders.duplicates.length - 10}{" "}
                            more duplicate folder groups
                          </div>
                        )}
                      </div>
                    </div>
          ...
          <section id="ignored" className="space-y-6 scroll-mt-24">
            ...
            {ignoredFilesLoading && (
              <div className="bg-white rounded-lg shadow p-8 text-center">
                <div className="w-16 h-16 mx-auto mb-4 animate-spin rounded-full border-4 border-blue-200 border-t-blue-600"></div>
                <h3 className="text-lg font-medium text-gray-900 mb-2">
                  Analyzing Ignored Files...
                </h3>
                <p className="text-gray-500">
                  Scanning for system files and thumbnails that are excluded
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-2xl font-bold text-gray-900">
                          {ignoredFiles.summary.total_ignored_files.toLocaleString()}
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <p className="text-sm font-medium text-gray-600">
                          Space Used by Ignored Files
                        </p>
                        <p className="text-2xl font-bold text-gray-900">
                          {formatBytes(
                            ignoredFiles.summary.total_ignored_size_bytes,
                          )}
                        </p>
                      </div>
                    </div>
                ...
                {ignoredFiles.breakdown.length > 0 && (
                  <div className="bg-white rounded-lg shadow">
                    <div className="px-6 py-4 border-b border-gray-200">
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        Files excluded from duplicate detection and gallery
                        display
                      </p>
                    </div>
                    <div className="p-6">
                              ...
                              <div className="mt-2">
                                ...
                                <div className="space-y-1">
                                  {category.examples.map((example, i) => (
                                    <div
                                      key={i}
                                      className="text-xs font-mono text-gray-500 bg-gray-50 px-2 py-1 rounded truncate"
                                    >
                                      {example}
                                    </div>
                                  ))}
                  ...
                  <div className="flex">
                    ...
                    <div className="text-sm">
                      <h4 className="text-blue-800 font-medium mb-1">
                        Why are files ignored?
                      </h4>
                      <p className="text-blue-700">
                        These files are automatically excluded from duplicate
                        detection to focus on actual photo duplicates. This
                        includes system thumbnails, metadata files, and very
                        small files that are likely not photos. Future updates
                        may include cleanup options for these files.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex justify-between text-sm">
                        ...
                        <span>
                          {(
                            (stats.metadata.photos_with_metadata /
                              stats.basic.total_photos) *
                            100
                          ).toFixed(1)}
                          %
                        </span>
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2 mt-1">
                        <div
                          className="bg-blue-600 h-2 rounded-full"
                          style={{
                            width: `${(stats.metadata.photos_with_metadata / stats.basic.total_photos) * 100}%`,
                          }}
                        ></div>
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2 mt-1">
                        <div
                          className="bg-green-600 h-2 rounded-full"
                          style={{
                            width: `${(stats.metadata.photos_with_camera_info / stats.basic.total_photos) * 100}%`,
                          }}
                        ></div>
                      </div>
                    </div>
                    <div>
                      <div className="flex justify-between text-sm">
                        ...
                        <span>
                          {(
                            (stats.metadata.photos_with_date_taken /
                              stats.basic.total_photos) *
                            100
                          ).toFixed(1)}
                          %
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2 mt-1">
                        <div
                          ...
                          style={{
                            width: `${(stats.metadata.photos_with_date_taken / stats.basic.total_photos) * 100}%`,
                          }}
                        ></div>
                      </div>
                    </div>
                    <div>
                      <div className="flex justify-between text-sm">
                        ...
                        <span>
                          {(
                            (stats.metadata.photos_with_location /
                              stats.basic.total_photos) *
                            100
                          ).toFixed(1)}
                          %
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2 mt-1">
                        <div
                          className="bg-purple-600 h-2 rounded-full"
                          style={{
                            width: `${(stats.metadata.photos_with_location / stats.basic.total_photos) * 100}%`,
                          }}
                        ></div>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="text-center">
                      <div className="text-2xl font-bold text-gray-600">
                        {stats.sync_health.total_folders}
                      </div>
