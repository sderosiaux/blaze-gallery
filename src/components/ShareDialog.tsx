...
import { X, Share2, Lock, Calendar, Download, Copy, Check, Eye, EyeOff } from "lucide-react";
...
export default function ShareDialog({ isOpen, onClose, folderPath, folderName }: ShareDialogProps) {
              ...
              <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                ...
                {shareData.share.description && (
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium">{shareData.share.description}</span>
                  </div>
                )}
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Password:</span>
                  <span className="font-medium">{password ? 'Protected' : 'None'}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Downloads:</span>
                  <span className="font-medium">{shareData.share.allow_download ? 'Allowed' : 'Disabled'}</span>
                </div>
